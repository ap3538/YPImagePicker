...
internal final class YPLibraryVC: UIViewController, YPPermissionCheckable {
    ...
    @objc func manageButtonTapped() {
        ...
        actionSheet.addAction(UIAlertAction(title: "Select More Photos", style: .default, handler: { [weak self] _ in
            // Your code to present photo picker
            self?.showPhotoPicker()
        }))
        
        actionSheet.addAction(UIAlertAction(title: "Change Settings", style: .default, handler: { _ in
    ...
    // Additional function to present the photo picker.
    func showPhotoPicker() {
        // Your photo picker presentation code here
    }
